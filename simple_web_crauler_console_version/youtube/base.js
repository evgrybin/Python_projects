var _yt_www={};(function(g){var window=this;var fa,la,ka,ma,baa,oa,pa,daa,eaa,Ta,nb,naa,rb,paa,nc,qaa,raa,oc,saa,uaa,Ac,Cc,Dc,Hc,vaa,Kc,Rc,Qc,xaa,Uc,Vc,Wc,Xc,yaa,Yc,Zc,cd,zaa,dd,ld,td,rd,od,Baa,wd,ud,vd,zd,Aaa,Hd,Caa,Daa,Jd,Ld,Faa,Qd,Rd,Sd,Gaa,$d,je,ke,ne,pe,Iaa,re,Be,Ke,Laa,Qe,Se,Maa,Naa,Oaa,$e,af,Paa,ff,df,bf,hf,pf,zf,Af,Waa,Hf,Xf,Wf,Xaa,kg,jg,Yaa,$aa,bba,Bg,Cg,Dg,Eg,Gg,Jg,Kg,Qg,Pg,Tg,Ug,Vg,eba,Zg,ch,iba,Mg,Sg,bh,hh,lba,mba,ah,kh,eh,Lg,Rg,dh,lh,Hg,Xg,Ig,gba,nh,oh,qh,oba,ph,th,mh,vh,pba,rh,sh,qba,Bh,Jh,Mh,Oh,Rh,Wh,rba,xba,wba,vba,bi,uba,sba,
tba,yba,zba,Bba,Cba,pi,ki,mi,ri,Dba,si,ui,Eba,Fba,vi,wi,Ci,Gi,Hi,Ii,Mi,Ni,Oi,Lba,Mba,Di,Fi,Ai,Kba,Ei,Si,Nba,Zi,Ri,Oba,Yi,Pba,Tba,Sba,Vba,aj,Wba,Qba,Rba,Xba,cj,Uba,$i,Yba,$ba,bca,aca,Zba,dj,ej,fj,ca,gj,Ba,caa;g.ba=function(a){return function(){return g.aa[a].apply(this,arguments)}};
...
oa=function(a,b){if(b){for(var c=ha,d=a.split("."),e=0;e<d.length-1;e++){var f=d[e];f in c||(c[f]={});c=c[f]}d=d[d.length-1];e=c[d];f=b(e);f!=e&&null!=f&&ia(c,d,{configurable:!0,writable:!0,value:f})}};
...
for(var e=[],f=[],k=[],l=[128],p=1;64>p;++p)l[p]=0;var q,w;a();return{reset:a,update:c,digest:d,Xv:function(){for(var a=d(),b="",c=0;c<a.length;c++)b+="0123456789ABCDEF".charAt(Math.floor(a[c]/16))+"0123456789ABCDEF".charAt(a[c]%16);return b}}};
...
oc=function(a){var b=qaa();b.update(a);return b.Xv().toLowerCase()};
...
g.vc=function(a,b){this.type=a;this.currentTarget=this.target=b;this.defaultPrevented=this.F=!1;this.Os=!0};
...
return a[Sc]};
g.Tc=function(){g.rc.call(this);this.vd=new g.Bc(this);this.ev=this;this.Vl=null};
Uc=function(a,b,c,d){b=a.vd.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var k=b[f];if(k&&!k.qg&&k.capture==c){var l=k.listener,p=k.Yg||k.src;k.Qh&&Cc(a.vd,k);e=!1!==l.call(p,d)&&e}}return e&&0!=d.Os};
...
if("undefined"!==typeof a&&!g.ib()){var b=new a,c={},d=c;b.port1.onmessage=function(){if(g.qa(c.next)){c=c.next;var a=c.Gn;c.Gn=null;a()}};
...
g.Dd=function(a,b,c){g.rc.call(this);this.C=a;this.D=b||0;this.F=c;this.uc=(0,g.t)(this.Hk,this)};
...
g.Ae=function(a){window.clearInterval(a)};
...
b.Zq&&0<b.timeout&&(f=g.we(function(){e||(e=!0,g.ye(f),b.Zq.call(b.context||g.m))},b.timeout))}else g.F(a,b)};
...
return k};
$e=function(a,b){b.gB&&(a=window.document.location.protocol+"//"+window.document.location.hostname+(window.document.location.port?":"+window.document.location.port:"")+a);var c=g.B("XSRF_FIELD_NAME",void 0),d=b.ua;d&&(d[c]&&delete d[c],a=g.Ye(a,d));return a};
af=function(a,b){var c=g.B("XSRF_FIELD_NAME",void 0),d=g.B("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.ka,k=g.B("XSRF_FIELD_NAME",void 0),l;b.headers&&(l=b.headers["Content-Type"]);b.qw||g.de(a)&&!b.withCredentials&&g.de(a)!=window.document.location.hostname||"POST"!=b.method||l&&"application/x-www-form-urlencoded"!=l||b.ka&&b.ka[k]||(f||(f={}),f[c]=d);f&&g.ra(e)&&(e=g.We(e),g.hb(e,f),e=b.gs&&"JSON"==b.gs?JSON.stringify(e):g.he(e));f=e||f&&!g.cb(f);!cf&&f&&"POST"!=b.method&&(cf=!0,g.oe(Error("AJAX request with postData should use POST")));
return e};
...
g.Qf=function(a){a=a.C;a={client:{hl:a.kB,gl:a.jB,clientName:a.iB,clientVersion:a.innertubeContextClientVersion}};g.B("DELEGATED_SESSION_ID")&&(a.user={onBehalfOfUser:g.B("DELEGATED_SESSION_ID")});return{context:a}};
g.Rf=function(a,b,c,d){!g.B("VISITOR_DATA")&&.01>Math.random()&&g.oe(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json","X-Goog-Visitor-Id":g.B("VISITOR_DATA","")},method:"POST",ka:c,gs:"JSON",gc:function(){d.gc()},
Zq:d.gc,Z:function(a,b){d.Z&&d.Z(b)},
Yq:function(a){d.Z&&d.Z(a)},
onError:function(a,b){if(d.onError)d.onError(b)},
Xq:function(a){if(d.onError)d.onError(a)},
timeout:d.timeout,withCredentials:!0},f=saa();f&&(e.headers.Authorization=f,e.headers["X-Goog-AuthUser"]=g.B("SESSION_INDEX",0));var k="",l=a.C.lB;l&&(k=l);f&&!k&&(e.headers["x-origin"]=window.location.origin);a=""+k+Xaa(a.C.innertubeApiVersion,b,c)+"?alt=json&key="+a.C.innertubeApiKey;g.se("use_fetch_for_op_xhr")?Oaa(a,e):g.gf(a,e)};
...
nh=function(a,b){g.rc.call(this);this.H=this.oa=a;this.N=b;this.L=!1;this.api={};this.aa=this.W=null;this.R=new g.Nd;g.uc(this,this.R);this.D={};this.ma=this.ia=this.F=this.ib=this.C=null;this.V=!1;this.G=this.J=null;this.Sa={};this.sb=["onReady"];this.eb=null;this.nb=window.NaN;this.X={};mh(this);this.Ih("WATCH_LATER_VIDEO_ADDED",(0,g.t)(this.gG,this));this.Ih("WATCH_LATER_VIDEO_REMOVED",(0,g.t)(this.hG,this));this.Ih("onAdAnnounce",(0,g.t)(this.bv,this));this.wb=new zf(this);g.uc(this,this.wb)};
...
oba=function(a){if(!a.qb()&&!a.V){var b=qh(a);if(b&&"html5"==(ph(a)?"html5":null))a.ma="html5",a.L||a.tj();else if(rh(a),a.ma="html5",b&&a.G)a.oa.appendChild(a.G),a.tj();else{a.C.loaded=!0;var c=!1;a.J=(0,g.t)(function(){c=!0;var a=this.C.clone();g.r("yt.player.Application.create")(this.oa,a);this.tj()},a);
a.V=!0;b?a.J():(g.Ie(a.C.assets.js,a.J),g.tg(a.C.assets.css),sh(a)&&!c&&g.n("yt.player.Application.create",null,void 0))}}};
ph=function(a){var b=g.x(a.F);!b&&a.H&&a.H.querySelector&&(b=a.H.querySelector("#"+a.F));return b};
th=function(a,b,c){var d=b[c];return function(){try{return a.eb=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.eb=e,g.qe(e))}}};
mh=function(a){a.L=!1;if(a.aa)for(var b in a.D)a.aa(b,a.D[b]);for(var c in a.X)g.ye((0,window.parseInt)(c,10));a.X={};a.W=null;a.aa=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=(0,g.t)(a.Ih,a);a.api.removeEventListener=(0,g.t)(a.yK,a);a.api.destroy=(0,g.t)(a.dispose,a);a.api.getLastError=(0,g.t)(a.gx,a);a.api.getPlayerType=(0,g.t)(a.zx,a);a.api.getCurrentVideoConfig=(0,g.t)(a.Iw,a);a.api.loadNewVideoConfig=(0,g.t)(a.Il,a);a.api.isReady=(0,g.t)(a.ZB,a)};
vh=function(a,b){var c=b;if("string"==typeof b){if(a.Sa[b])return a.Sa[b];c=function(){var a=g.r(b);a&&a.apply(g.m,arguments)};
a.Sa[b]=c}return c?c:null};
pba=function(a,b){var c="ytPlayer"+b+a.N,d=(0,g.t)(function(a){var c=this.C&&this.C.args&&this.C.args.fflags;if(c&&0>c.indexOf("use_html5_player_event_timeout=true"))this.R.qa(b,a);else{var d=g.we((0,g.t)(function(){this.qb()||(this.R.qa(b,a),g.db(this.X,String(d)))},this),0);
g.eb(this.X,String(d),!0)}},a);
a.D[b]=c;g.m[c]=d;return c};
rh=function(a){g.Og("dcp");a.cancel();mh(a);a.ma=null;a.C&&(a.C.loaded=!1);var b=ph(a);b&&(qh(a)||!sh(a)?a.G=b:(b&&b.destroy&&b.destroy(),a.G=null));g.dc(a.oa)};
sh=function(a){return a.C&&a.C.args&&a.C.args.fflags?-1!=a.C.args.fflags.indexOf("player_destroy_old_version=true"):!1};
g.yh=function(a,b){a=g.ra(a)?g.Vb(a):a;b=g.Bf(b);var c=g.wh+"_"+g.Ca(a),d=g.xh[c];if(d)return d.Il(b),d.api;d=new nh(a,c);g.xh[c]=d;g.E("player-added",d.api);g.sc(d,g.u(qba,d));g.we(function(){d.Il(b)},0);
return d.api};
qba=function(a){delete g.xh[a.getId()]};
g.zh=function(a){if(!a)return null;var b=g.wh+"_"+g.Ca(a),c=g.xh[b];c||(c=new nh(a,b),g.xh[b]=c);return c.api};
g.Ah=function(a){return g.zh(window.document.getElementById(a))};
Bh=function(){var a=g.qg(),b=g.sg();b&&a&&g.ig(b,[a],!0)};
g.Fh=function(a){var b=9E4+2E3*Math.random();if("FOREGROUND_HEARTBEAT_TRIGGER_ON_INTERVAL"!=a||!(g.$f()>b)&&"visible"==g.nf()){b=-1;g.Ch&&(b=Math.round(g.Pf()-g.Ch));var c=String;var d=g.r("_fact",window);d=null==d||-1==d?-1:Math.max((0,g.Ud)()-d,0);a={firstActivityMs:c(d),clientDocumentNonce:g.Dh,index:String(Eh),lastEventDeltaMs:String(b),trigger:a};g.bg("foregroundHeartbeat",a);g.n("_fact",-1,window);Eh++;g.Ch=g.Pf()}};
g.Gh=function(a,b,c,d,e){this.name=a;this.deps=b||[];this.page=c||"";this.L=d?pe(d):null;this.H=e?pe(e):null;this.G=[];this.C=this.F=0};
g.Hh=function(a){g.Oe(a.F);a.F=g.Ne((0,g.t)(a.init,a))};
g.Kh=function(a){a.name in Ih&&Jh(a.name);Ih[a.name]={reqs:[],disable:(0,g.t)(a.disable,a)};(0,g.y)(a.deps,function(b){if(!(b in Ih))throw Error("Module "+b+" required by "+a.name);Ih[b].reqs.push(a.name)});
a.enable()};
Jh=function(a){if(a in Ih){var b=Ih[a];(0,g.y)(b.reqs,function(a){Jh(a)});
try{b.disable()}catch(c){}delete Ih[a]}};
Mh=function(a){ke(g.Lh,arguments)};
g.Nh=function(a){return a in g.Lh};
Oh=function(a){ke(g.Lh,arguments)};
g.Qh=function(a,b,c,d){g.Ph.set(""+a,b,c,"/",void 0===d?"youtube.com":d,!1)};
g.Sh=function(a,b,c){var d=g.B("VALID_SESSION_TEMPDATA_DOMAINS",[]),e=g.de(window.location.href);e&&d.push(e);e=g.de(a);if(g.Ha(d,e)||!e&&g.Na(a,"/"))if(g.se("autoescape_tempdata_url")&&(d=window.document.createElement("a"),g.Ob(d,a),a=d.href),a&&(a=g.ee(a),d=a.indexOf("#"),a=0>d?a:a.substr(0,d))){if(b.itct||b.ved)b.csn=b.csn||g.sg();c?(c=(0,window.parseInt)(c,10),(0,window.isFinite)(c)&&0<c&&(a="ST-"+g.Va(a).toString(36),d=b?g.he(b):"",g.Qh(a,d,c||5),Rh(b))):(c="ST-"+g.Va(a).toString(36),a=b?g.he(b):
"",g.Qh(c,a,5),Rh(b))}};
Rh=function(a){if(a){a=a.itct||a.ved;var b=g.r("yt.logging.screen.storeParentElement");a&&b&&b(g.gg(a))}};
g.Th=function(a,b){b=void 0===b?{}:b;var c=void 0===c?"":c;var d=void 0===d?window:d;g.Pb(d.location,g.ie(a,b)+c)};
g.Uh=function(a,b){b&&g.Sh(a,b);(window.ytspf||{}).enabled?window.spf.navigate(a):g.Th(a)};
g.Vh=function(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=g.B("EVENT_ID");d&&(b.ei||(b.ei=d));b&&g.Sh(a,b);if(c)return!1;g.Uh(a);return!0};
g.Xh=function(a,b){var c={};c.key=a;c.value=b;return Wh().then(function(a){return new window.Promise(function(b,d){var e=a.transaction("swpushnotificationsstore","readwrite").objectStore("swpushnotificationsstore").put(c);e.onsuccess=b;e.onerror=d})})};
g.Yh=function(a){return Wh().then(function(b){return new window.Promise(function(c,d){var e=b.transaction("swpushnotificationsstore").objectStore("swpushnotificationsstore").get(a);e.onsuccess=function(){var a=e.result;c(a?a.value:null)};
...
Wh=function(){return Zh?window.Promise.resolve(Zh):new window.Promise(function(a,b){var c=window.self.indexedDB.open("swpushnotificationsdb");c.onerror=b;c.onsuccess=function(){var b=c.result;if(b.objectStoreNames.contains("swpushnotificationsstore"))Zh=b,a(Zh);else return window.self.indexedDB.deleteDatabase("swpushnotificationsdb"),Wh()};
...
xba=function(){$h++;var a=g.Zb(),b=new g.hc(0,0,a.width,a.height);Pg("vph",a.height);Pg("vpw",a.width);g.Og("vpc");a=window.document.querySelectorAll(".yt-lockup-thumbnail img[data-ytimg]");var c=a.length,d=[],e=!0;ai.start();for(var f=0;f<c;f++){var k=a[f];if(bi(k,b)){var l=sba(k);l.then(tba);d.push(l);ci.push(l);k.loadTime||(e=!1)}}e&&Pg("yt_eil",1);g.Og("vpcc");b=g.qd(d).then(uba);g.sd(b,vba);b.then(wba);ci.push(b);return b};
wba=function(){ai.stop()};
vba=function(){g.Og("vpr")};
bi=function(a,b){for(var c=a,d=[];c!=window.document.body;){var e=g.mf(c);if(e in di)return!0;if(e in ei)return!1;var f=window.getComputedStyle(c);if("none"==f.display||"hidden"==f.visibility)return ei[e]=!0,!1;f=c.getBoundingClientRect();if(!(b.left<=f.left+f.width&&f.left<=b.left+b.width&&b.top<=f.top+f.height&&f.top<=b.top+b.height))return ei[e]=!0,!1;d.push(e);c=c.parentElement}for(c=0;c<d.length;c++)di[d[c]]=!0;return!0};
uba=function(a){var b=g.Zb();b=new g.hc(0,0,b.width,b.height);for(var c=0,d=0,e=a.length;d<e;d++){var f=a[d].time;bi(a[d].fB,b)&&c<f&&(c=f)}return c};
sba=function(a){var b=$h;return new g.kd(function(c,d){var e={fB:a,time:0};a.loadTime?(e.time=(0,window.parseInt)(a.loadTime,10),c(e)):(a.slt=function(){$h!=b?d():(e.time=(0,window.parseInt)(a.loadTime,10),c(e),a.slt=void 0)},fi.push(a))})};
tba=function(a){ai.start();a=a.time;gi<a&&(gi=a,g.Og("lim",a))};
yba=function(){g.Og("vptl",gi);g.Og("vpl",gi)};
zba=function(){ci.forEach(function(a){a.cancel()});
gi=ci.length=0;di={};ei={};fi.forEach(function(a){a.slt=void 0});
fi.length=0};
g.hi=function(a,b){g.ug("/gen_204?"+a,b)};
Bba=function(a){if(null==a)return[];var b=[];Aba.forEach(function(c){c in a&&(delete a[c],b.push(c))});
a.cached_load="1";return b};
g.ii=function(){return g.A(g.x("page-container"),"remote-connected")};
Cba=function(){ji=g.xe(ki,5E3);var a=g.li();a?(a.addEventListener("onReady",ki),a.addEventListener("onStateChange",ki)):mi("unable to init PP monitor")};
pi=function(a){for(var b in g.xh){var c=g.xh[b];c&&c.cancel()}if(a=a||null){b=g.li();var d=!0;c=g.ni;g.ni=null;b&&b.getVideoData&&c&&(d=b.getVideoData(),d=!!c.fullscreen||d.video_id!=a.args.video_id||d.list!=a.args.list||d.video_id!=c.videoId||d.list!=c.listId);d?(oi="",g.yh("player-api",a)):b.playVideo();a=g.Bf(a);a.loaded=!0}ki();g.n("ytplayer.config",a,void 0)};
g.li=function(){return g.Ah("player-api")};
ki=function(){var a=g.li();if(a){var b=g.x("player");b=!b||g.A(b,"off-screen");var c=1==(a&&a.isReady()?a.getPlayerState():void 0),d="watch"==g.B("PAGE_NAME"),e=g.ii();!c||d||e||(mi("PP playing off watch (paused)"),a.pauseVideo());b&&d?mi("PP off-screen on watch"):b||d||mi("PP !off-screen off watch")}};
mi=function(a){var b=g.B("PAGE_NAME");b&&(a+="("+[b,oi,g.r("_spf_state.nav-counter")].join()+")",g.n("yt.www.persistentplayer.issue",a,void 0),g.oe(Error(a),"WARNING"))};
ri=function(){g.Og("ol");window.requestAnimationFrame&&!window.document.hidden?window.requestAnimationFrame(function(){(0,window.setTimeout)(function(){g.Og("cpt");g.E("on_cpt_tick",(new Date).getTime())},0)}):window.document.hidden?(g.Og("cpt"),g.E("on_cpt_tick",(new Date).getTime())):(0,window.setTimeout)(function(){g.Og("cpt");
g.E("on_cpt_tick",(new Date).getTime())},0);
Dba();g.B("CSI_VIEWPORT")&&(qi=xba(),qi.then(function(a){g.Og("vpl",a);qi=null},function(){}))};
Dba=function(){si("init");var a=g.B("PAGE_NAME",void 0);a&&si("init-"+a)};
si=function(a){g.Re()?ti.push(g.Ne(g.u(g.Ge,a),0)):g.E(a)};
ui=function(){g.Pe(ti);ti.length=0;zba();qi&&(qi.cancel(),qi=null);var a=g.B("PAGE_NAME",void 0);a&&g.Ge("dispose-"+a);g.Ge("dispose")};
Eba=function(){ri()};
Fba=function(){g.B("TIMING_REPORT_ON_UNLOAD")&&g.Ng(!0);ch("u");g.Fh("FOREGROUND_HEARTBEAT_TRIGGER_ON_BACKGROUND");Bh();g.eg();g.If();ui();g.Ge("pageunload")};
vi=function(){Wf()};
wi=function(a){a=a.detail.url;window.yt_spf_loaded_history=!0;Wf();var b=g.rg();if(b&&a){var c=g.hg(b.visualElement);b={csn:b.clientScreenNonce};"trackingParams"in c?b.itct=c.trackingParams:(b.veType=c.veType,b.veCounter=c.veCounter);g.Sh(a,b)}};
Ci=function(){xi=1;yi=zi=0;g.B("TIMING_REPORT_ON_UNLOAD")&&g.Ng(!0);g.se("warm_load_nav_start_web")?(ch("n"),Jg(),kh(!1),g.me("TIMING_AFT_KEYS",[]),Pg("yt_lt","warm"),g.me("TIMING_ACTION",""),g.me("TIMING_WAIT",[]),Cg()):(ch("n"),Jg());Qg("n");Kg("nr");Ai(Gba);Bh();g.Ge("navigate")};
Gi=function(a){a=a.detail.part||a.detail.partial;g.Og("nc"+zi);++zi;if(a&&a.data&&a.data.deferDispose)"watch"==a.name&&g.Og("bc");else{var b=1==xi;xi=2;b?(Ai(Hba),Di()):Ai(Iba);if(b=a&&a.data&&a.data.swfcfg)Ei(a.timing,b.args),Fi(b)}};
Hi=function(){g.Og("np"+yi);++yi};
Ii=function(a){a=a.detail.response;var b=1==xi;xi=3;b&&(Ai(Jba),Di());if(b=a.data&&a.data.swfcfg)Ei(a.timing,b.args),Fi(b)};
Mi=function(a){g.Og("nd");a=a.detail.response;g.Ji=a.cacheKey;a=a.timing;var b=window._spf_state;g.Ki.navigationCount=b&&b["nav-counter"]||0;g.se("warm_load_nav_start_web")?g.Og("srt",a.responseStart):(Qg("ne",a.responseStart),Pg("srt",Math.max(0,a.responseStart-a.navigationStart)));Pg("yt_lt",a.spfCached?"hot":"warm");Pg("yt_pft",+!!a.spfPrefetched);g.Og("pfs",a.fetchStart);g.Og("pfrs",a.responseStart);"redirectStart"in a&&Vg(a);Ai(Li);window.document.getElementById("content").style.height="";ri();
xi=0};
Ni=function(a){var b=a.detail.url;if(a=a.detail.err)a.message&&(a.message+=" (url: "+b+")"),g.oe(a)};
Oi=function(a){g.hi(g.he({spfreload:"1",url:a.detail.url,reason:a.detail.reason}))};
Lba=function(){Kba();window.yt_spf_loaded_history=!1};
Mba=function(){};
Di=function(){var a=window.document.getElementById("content");-1<a.className.indexOf("spf-animate")&&(a.style.height=a.clientHeight+"px");ui();a=g.B("PREVIOUS_ACTION");for(var b in g.le)delete g.le[b];g.me("PREVIOUS_ACTION",a);g.me("SERVED_VIA_SPF_HISTORY",!!window.yt_spf_loaded_history);g.n("ytplayer.config",null,void 0);if((b=g.li())&&b.stopVideo){if(b.stopVideo(),b=b.getLastError())oi=b,(b=g.x("movie_player"))&&b.stopVideo?(b.stopVideo(),oi="recovered"):oi="missing2"}else oi="missing";ki()};
Fi=function(a){"cfg"in Lg(void 0)||g.Og("cfg");pi(a)};
Ai=function(a){var b=window.document.getElementById("progress");b||(b=window.document.createElement("div"),b.id="progress",b.appendChild(window.document.createElement("dt")),b.appendChild(window.document.createElement("dd")),window.document.body.appendChild(b));g.Oe(Pi);Pi=g.Ne(function(){var c=a[0],d=a[1],e=a[2];b.className="";var f=b.style;f.transitionDuration=f.webkitTransitionDuration=c+"ms";f.width=d+"%";g.ye(Qi);Qi=g.we(function(){b.className=e},c)},0)};
Kba=function(){var a=Li[0]+50;g.ye(Qi);Qi=g.we(function(){var a=window.document.getElementById("progress");a&&a.parentNode.removeChild(a)},a)};
Ei=function(a,b){var c=a&&a.spfCached,d=a&&a.spfPrefetched,e=[];c&&!d&&null!=b&&(e=Bba(b));g.B("EXP_DEBUG_PREFETCH")&&(e.sort(),c={a:"updatePlayerVarsForCachedLoad",cached:c,prefetched:d,deleted:e.join("")},g.hi(g.he(c)))};
...
Nba=function(){var a=g.Ti&&g.se("enable_firefox_push_notifications");return!(!g.Ui&&!a||g.Vi||g.Wi||g.Xi||!window.navigator.serviceWorker||!window.navigator.serviceWorker.getRegistration||!window.Notification||!window.Promise)};
Zi=function(){Yi({type:"notifications_register",data:g.B("ID_TOKEN")})};
Ri=function(){return window.navigator.serviceWorker.getRegistration(String(re("service_worker_scope")||""))};
Oba=function(){return Yi({type:"notifications_check_registration",data:g.B("ID_TOKEN")})};
...
Pba=function(){if(!g.B("LOGGED_IN",void 0))return window.Promise.resolve(!1);var a=String(re("service_worker_push_force_notification_prompt_tag")||"");return a?g.Yh("PromptTags").then(function(b){if(!b)return!0;var c=[];try{c=JSON.parse(b)}catch(d){return!1}return c&&-1==c.indexOf(a)}):window.Promise.resolve(!1)};
Tba=function(){return g.B("SERVICE_WORKER_PROMPT_NOTIFICATIONS",void 0)?Pba().then(function(a){if(a)return!0;a=[Qba(),Rba()];g.B("LOGGED_IN",void 0)||a.push(Sba());return window.Promise.all(a).then(function(a){return a.every(function(a){return a})})}):window.Promise.resolve(!1)};
Sba=function(){var a=g.te("service_worker_push_logged_out_prompt_watches");return-1==a?window.Promise.resolve(!1):g.Yh("WatchCount").then(function(b){return b>=a})};
Vba=function(){var a=arguments;g.se("service_worker_push_prompt_modal_enable")&&Uba();return window.Notification.requestPermission().then(function(a){$i();var b=window.document.getElementById("ticker");b&&(b.className=b.classList.remove("show"));if("granted"==a)return Si().then(function(){g.Xh("NotificationsDisabled",!1);Zi();return window.Promise.resolve(!0)});
"denied"==a&&Zi();return window.Promise.resolve(!1)})["catch"](function(){$i();
return window.Promise.reject.apply(window.Promise,[].concat(a instanceof Array?a:baa(g.na(a))))})};
aj=function(){return g.se("service_worker_push_home_only")?"HomePromptCount":"PromptCount"};
Wba=function(){var a=aj();g.Yh(a).then(function(b){return g.Xh(a,b+1)}).then(function(){if(g.se("service_worker_push_home_only"))return g.Xh("HomePromptTime",(0,g.Ud)())}).then(function(){var a=String(re("service_worker_push_force_notification_prompt_tag")||"");
if(a)return g.Yh("PromptTags").then(function(b){var c=[];if(b)try{c=JSON.parse(b)}catch(e){return!1}c||(c=[]);c.push(a);return g.Xh("PromptTags",JSON.stringify(c))})})};
Qba=function(){return-1==g.te("service_worker_push_prompt_cap")?window.Promise.resolve(!0):g.Yh(aj()).then(function(a){a||(a=0);return window.Promise.resolve(a<g.te("service_worker_push_prompt_cap"))})};
Rba=function(){var a=g.te("service_worker_push_prompt_delay_ms");return a?g.Yh("HomePromptTime").then(function(b){return window.Promise.resolve((0,g.Ud)()-a>(b||0))}):window.Promise.resolve(!0)};
Xba=function(){bj||$i()};
cj=function(a){a.style.zIndex=2147483648;a.style.pointerEvents="auto";a.style.backgroundColor="rgba(0, 0, 0, 0.6)";a.style.width="100%";a.style.height="100vh";a.style.position="absolute";a.style.top="0";a.style.left="0";a.style.border="none"};
Uba=function(){var a=g.x("yt-push-prompt-modal-bg");bj=g.se("service_worker_push_prompt_modal_ignore_click");a?cj(a):(a=g.bc("div",{id:"yt-push-prompt-modal-bg"}),cj(a),window.document.body.appendChild(a),g.wf(window.document,"click",Xba))};
$i=function(){var a=g.x("yt-push-prompt-modal-bg");a&&g.ec(a)};
Yba=function(a){return Nba()&&a&&a.pushManager?"default"!=window.Notification.permission?Si().then(Oba):Tba().then(function(a){if(a)return Wba(),Vba()}):window.Promise.resolve()};
$ba=function(){window.navigator.serviceWorker.getRegistrations().then(function(a){a.forEach(Zba)})};
bca=function(){var a="/sw.js",b=g.B("SERVICE_WORKER_VFL",void 0);b&&(a+="?vfl="+b);a=dj(a);g.se("service_worker_push_enabled")&&a.then(aca).then(Yba)};
...
Zba=function(a){a&&dj("/sw.js?0",a.scope)};
dj=function(a,b){return window.navigator.serviceWorker.register(a,{scope:b||String(re("service_worker_scope")||"")||"/"})};
ej=function(){g.Gh.call(this,"www/base");this.D=0};
fj=function(a){(a=a.detail.name)&&Jh(a)};
g.aa=[];ca="function"==typeof Object.create?Object.create:function(a){function b(){}
b.prototype=a;return new b};
if("function"==typeof Object.setPrototypeOf)gj=Object.setPrototypeOf;else{var hj;a:{var cca={a:!0},ij={};try{ij.__proto__=cca;hj=ij.a;break a}catch(a){}hj=!1}gj=hj?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}
var da=gj,ia="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)},ha="undefined"!=typeof window&&window===this?this:"undefined"!=typeof window.global&&null!=window.global?window.global:this,aaa=function(){var a=0;
...
var dca=function(){function a(){function a(){}
...
oa("Reflect.construct",function(){return dca});
...
g.jj=g.jj||{};g.m=this;Ba="closure_uid_"+(1E9*Math.random()>>>0);caa=0;g.Ud=Date.now||function(){return+new Date};g.v(g.Da,Error);g.Da.prototype.name="CustomError";g.Ga=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if(g.ra(a))return g.ra(b)&&1==b.length?a.indexOf(b,0):-1;
for(var c=0;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1};
g.eca=Array.prototype.lastIndexOf?function(a,b){return Array.prototype.lastIndexOf.call(a,b,a.length-1)}:function(a,b){var c=a.length-1;
...
return e};
g.kj=Array.prototype.some?function(a,b,c){return Array.prototype.some.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=g.ra(a)?a.split(""):a,f=0;f<d;f++)if(f in e&&b.call(c,e[f],f,a))return!0;
return!1};
g.lj=Array.prototype.every?function(a,b,c){return Array.prototype.every.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=g.ra(a)?a.split(""):a,f=0;f<d;f++)if(f in e&&!b.call(c,e[f],f,a))return!1;
...
gaa=/&/g;haa=/</g;iaa=/>/g;jaa=/"/g;kaa=/'/g;laa=/\x00/g;faa=/[\x00&<>"']/;g.mj=String.prototype.repeat?function(a,b){return a.repeat(b)}:function(a,b){return Array(b+1).join(a)};a:{var nj=g.m.navigator;if(nj){var oj=nj.userAgent;if(oj){g.Wa=oj;break a}}g.Wa=""};var gb="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");g.pb[" "]=g.ta;var wj,maa,Aj;g.pj=g.Xa("Opera");g.I=g.ib();g.qj=g.Xa("Edge");g.rj=g.qj||g.I;g.sj=g.Xa("Gecko")&&!(-1!=g.Wa.toLowerCase().indexOf("webkit")&&!g.Xa("Edge"))&&!(g.Xa("Trident")||g.Xa("MSIE"))&&!g.Xa("Edge");g.tj=-1!=g.Wa.toLowerCase().indexOf("webkit")&&!g.Xa("Edge");g.uj=g.Xa("Macintosh");g.vj=g.Xa("Windows");g.fca=g.Xa("Linux")||g.Xa("CrOS");g.gca=g.Xa("Android");g.Wi=nb();g.Xi=g.Xa("iPad");g.hca=g.Xa("iPod");g.ica=g.ob();
a:{var xj="",yj=function(){var a=g.Wa;if(g.sj)return/rv:([^\);]+)(\)|;)/.exec(a);if(g.qj)return/Edge\/([\d\.]+)/.exec(a);if(g.I)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(g.tj)return/WebKit\/(\S+)/.exec(a);if(g.pj)return/(?:Version)[ \/]?(\S+)/.exec(a)}();
yj&&(xj=yj?yj[1]:"");if(g.I){var zj=rb();if(null!=zj&&zj>(0,window.parseFloat)(xj)){wj=String(zj);break a}}wj=xj}g.sb=wj;maa={};var Bj=g.m.document;Aj=Bj&&g.I?rb()||("CSS1Compat"==Bj.compatMode?(0,window.parseInt)(g.sb,10):5):void 0;g.ub=Aj;var oaa;oaa=!g.I||g.vb(9);g.jca=!g.sj&&!g.I||g.I&&g.vb(9)||g.sj&&g.tb("1.9.1");g.Cj=g.I&&!g.tb("9");g.kca=g.I||g.pj||g.tj;g.xb.prototype.Nd=!0;g.xb.prototype.Sc=function(){return this.C};
g.xb.prototype.toString=function(){return"Const{"+this.C+"}"};
g.wb={};g.yb("");g.lca=RegExp("[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0800-\u1fff\u200e\u2c00-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.mca=RegExp("^[^\u0591-\u06ef\u06fa-\u07ff\u200f\ufb1d-\ufdff\ufe70-\ufefc]*[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0800-\u1fff\u200e\u2c00-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.Dj=RegExp("^[^A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0800-\u1fff\u200e\u2c00-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]*[\u0591-\u06ef\u06fa-\u07ff\u200f\ufb1d-\ufdff\ufe70-\ufefc]");var zb;g.Ab.prototype.Nd=!0;g.Ab.prototype.Sc=function(){return this.C};
g.Ab.prototype.il=!0;g.Ab.prototype.Ee=g.ba(1);g.Cb=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i;zb={};g.Db("about:blank");g.Gb.prototype.Nd=!0;g.Fb={};g.Gb.prototype.Sc=function(){return this.C};
g.Ej=g.Hb("");g.Fj=RegExp("\\b(url\\([ \t\n]*)('[ -&(-\\[\\]-~]*'|\"[ !#-\\[\\]-~]*\"|[!#-&*-\\[\\]-~]*)([ \t\n]*\\))","g");g.nca=RegExp("\\b(hsl|hsla|rgb|rgba|(rotate|scale|translate)(X|Y|Z|3d)?)\\([-0-9a-z.%, ]+\\)","g");g.Jb.prototype.Nd=!0;g.Ib={};g.Jb.prototype.Sc=function(){return this.C};
g.oca=g.Kb("");g.Mb.prototype.il=!0;g.Mb.prototype.Ee=g.ba(0);g.Mb.prototype.Nd=!0;g.Mb.prototype.Sc=function(){return this.C};
g.Lb={};g.Nb("<!DOCTYPE html>",0);g.Gj=g.Nb("",0);g.Hj=g.Nb("<br>",0);g.h=g.Rb.prototype;g.h.clone=function(){return new g.Rb(this.x,this.y)};
...
g.h.scale=function(a,b){var c=g.sa(b)?b:a;this.width*=a;this.height*=c;return this};var Wb={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",frameborder:"frameBorder",height:"height",maxlength:"maxLength",nonce:"nonce",role:"role",rowspan:"rowSpan",type:"type",usemap:"useMap",valign:"vAlign",width:"width"};g.Ij=window.document;g.Jj=window;g.Ij.getElementsByTagName("script");g.h=g.hc.prototype;g.h.clone=function(){return new g.hc(this.left,this.top,this.width,this.height)};
...
g.h.scale=function(a,b){var c=g.sa(b)?b:a;this.left*=a;this.width*=a;this.top*=c;this.height*=c;return this};g.Kj=g.sj?"MozUserSelect":g.tj||g.qj?"WebkitUserSelect":null;g.Lj=g.lc(null);g.pca=Object.prototype.hasOwnProperty;g.Mj=g.mc(window);g.Nj=g.Mj&&window.parent||window;g.Oj=(new Date).getTime();g.h=g.pc.prototype;g.h.isEnabled=function(){return window.navigator.cookieEnabled};
...
g.Ph=new g.pc("undefined"==typeof window.document?null:window.document);g.Ph.F=3950;g.rc.prototype.Hc=!1;g.rc.prototype.qb=function(){return this.Hc};
...
g.vc.prototype.preventDefault=function(){this.defaultPrevented=!0;this.Os=!1};var Mc,rca,waa;g.qca=!g.I||g.vb(9);Mc=!g.I||g.vb(9);rca=g.I&&!g.tb("9");waa=function(){if(!g.m.addEventListener||!Object.defineProperty)return!1;var a=!1,b=Object.defineProperty({},"passive",{get:function(){a=!0}});
g.m.addEventListener("test",g.ta,b);g.m.removeEventListener("test",g.ta,b);return a}();g.Pj=g.I?"focusin":"DOMFocusIn";g.Qj=g.I?"focusout":"DOMFocusOut";g.Rj=g.tj?"webkitTransitionEnd":g.pj?"otransitionend":"transitionend";g.v(g.xc,g.vc);var sca={2:"touch",3:"pen",4:"mouse"};
g.xc.prototype.init=function(a,b){var c=this.type=a.type,d=a.changedTouches?a.changedTouches[0]:null;this.target=a.target||a.srcElement;this.currentTarget=b;var e=a.relatedTarget;e?g.sj&&(g.qb(e,"nodeName")||(e=null)):"mouseover"==c?e=a.fromElement:"mouseout"==c&&(e=a.toElement);this.relatedTarget=e;null===d?(this.clientX=void 0!==a.clientX?a.clientX:a.pageX,this.clientY=void 0!==a.clientY?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0):(this.clientX=void 0!==d.clientX?d.clientX:
d.pageX,this.clientY=void 0!==d.clientY?d.clientY:d.pageY,this.screenX=d.screenX||0,this.screenY=d.screenY||0);this.button=a.button;this.keyCode=a.keyCode||0;this.key=a.key||"";this.charCode=a.charCode||("keypress"==c?a.keyCode:0);this.ctrlKey=a.ctrlKey;this.altKey=a.altKey;this.shiftKey=a.shiftKey;this.metaKey=a.metaKey;this.L=g.uj?a.metaKey:a.ctrlKey;this.pointerId=a.pointerId||0;this.pointerType=g.ra(a.pointerType)?a.pointerType:sca[a.pointerType]||"";this.state=a.state;this.wc=a;a.defaultPrevented&&
this.preventDefault()};
...
g.h.hasListener=function(a,b){var c=g.qa(a),d=c?a.toString():"",e=g.qa(b);return g.Za(this.listeners,function(a){for(var f=0;f<a.length;++f)if(!(c&&a[f].type!=d||e&&a[f].capture!=b))return!0;return!1})};var Jc="closure_lm_"+(1E6*Math.random()|0),Pc={},Lc=0,Sc="__closure_events_fn_"+(1E9*Math.random()>>>0);g.v(g.Tc,g.rc);g.Tc.prototype[yc]=!0;g.h=g.Tc.prototype;g.h.ti=function(){return this.Vl};
...
g.h.Hk=function(){this.ob=0;this.C&&this.C.call(this.F)};g.Ti=g.Xa("Firefox");g.Sj=nb()||g.Xa("iPod");g.Tj=g.Xa("iPad");g.Vi=g.mb();g.Ui=g.kb();g.Uj=g.lb()&&!g.ob();g.Gd="StopIteration"in g.m?g.m.StopIteration:{message:"StopIteration",stack:""};g.Fd.prototype.next=function(){throw g.Gd;};
...
g.h.key=function(a){return this.C.key(a)};g.v(g.Zd,g.Yd);g.v($d,g.Yd);var Haa=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/;var Vj=!1,Wj="";
(function(){if(window.navigator.plugins&&window.navigator.plugins.length){var a=window.navigator.plugins["Shockwave Flash"];if(a&&(Vj=!0,a.description)){Wj=je(a.description);return}if(window.navigator.plugins["Shockwave Flash 2.0"]){Vj=!0;Wj="2.0.0.11";return}}if(window.navigator.mimeTypes&&window.navigator.mimeTypes.length&&(a=window.navigator.mimeTypes["application/x-shockwave-flash"],Vj=!(!a||!a.enabledPlugin))){Wj=je(a.enabledPlugin.description);return}try{var b=new window.ActiveXObject("ShockwaveFlash.ShockwaveFlash.7");Vj=
!0;Wj=je(b.GetVariable("$version"));return}catch(c){}try{b=new window.ActiveXObject("ShockwaveFlash.ShockwaveFlash.6");Vj=!0;Wj="6.0.21";return}catch(c){}try{b=new window.ActiveXObject("ShockwaveFlash.ShockwaveFlash"),Vj=!0,Wj=je(b.GetVariable("$version"))}catch(c){}})();
g.tca=Vj;g.uca=Wj;g.Pf=window.performance&&window.performance.timing&&window.performance.now?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};
g.Xj="Microsoft Internet Explorer"==window.navigator.appName;g.le=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};g.n("yt.config_",g.le,void 0);var ve={};var vca=g.r("ytPubsubPubsubInstance")||new g.Nd;g.Nd.prototype.subscribe=g.Nd.prototype.subscribe;g.Nd.prototype.unsubscribeByKey=g.Nd.prototype.qd;g.Nd.prototype.publish=g.Nd.prototype.qa;g.Nd.prototype.clear=g.Nd.prototype.clear;g.n("ytPubsubPubsubInstance",vca,void 0);var Ce=g.r("ytPubsubPubsubSubscribedKeys")||{};g.n("ytPubsubPubsubSubscribedKeys",Ce,void 0);var Ee=g.r("ytPubsubPubsubTopicToKeys")||{};g.n("ytPubsubPubsubTopicToKeys",Ee,void 0);var De=g.r("ytPubsubPubsubIsSynchronous")||{};
...
g.yf.prototype.Y=function(){g.Ae(this.N);g.vf(this.J)};g.ea(zf,g.rc);zf.prototype.Wa=function(a){for(var b=0;b<this.C.length;b++)if(this.C[b]==a){this.C.splice(b,1);a.target.removeEventListener(a.name,a.Vf);break}};
...
g.n("ytLoggingTransportDispatchedStats_",Of,void 0);var Tf=g.r("ytLoggingTransportCapturedTime_")||{};g.n("ytytLoggingTransportCapturedTime_",Tf,void 0);var Zf={};var lg=g.r("ytLoggingLatencyUsageStats_")||{};g.n("ytLoggingLatencyUsageStats_",lg,void 0);var mg=0;var Zj,ak;Zj=new g.Zd;g.og=Zj.isAvailable()?new g.Wd(Zj):null;ak=new $d;g.ng=ak.isAvailable()?new g.Wd(ak):null;var Zaa=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;var vg={},aba=0;g.xg.prototype.toString=function(){return this.topic};var xca=g.r("ytPubsub2Pubsub2Instance")||new g.Nd;g.Nd.prototype.subscribe=g.Nd.prototype.subscribe;g.Nd.prototype.unsubscribeByKey=g.Nd.prototype.qd;g.Nd.prototype.publish=g.Nd.prototype.qa;g.Nd.prototype.clear=g.Nd.prototype.clear;g.n("ytPubsub2Pubsub2Instance",xca,void 0);g.bk=g.r("ytPubsub2Pubsub2SubscribedKeys")||{};g.n("ytPubsub2Pubsub2SubscribedKeys",g.bk,void 0);g.ck=g.r("ytPubsub2Pubsub2TopicToKeys")||{};g.n("ytPubsub2Pubsub2TopicToKeys",g.ck,void 0);
g.dk=g.r("ytPubsub2Pubsub2IsAsync")||{};g.n("ytPubsub2Pubsub2IsAsync",g.dk,void 0);g.n("ytPubsub2Pubsub2SkipSubKey",null,void 0);var Ag=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};g.ea(Dg,g.wg);g.ea(Eg,g.wg);var dba=new g.xg("aft-recorded",Dg),hba=new g.xg("timing-sent",Eg);var Fg=(0,g.Ud)().toString();var fba={vc:!0},gh={'script[name="scheduler/scheduler"]':"sj",'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'link[rel="stylesheet"][name="player/www-player"]':"pc",'script[name="desktop_polymer/desktop_polymer"]':"dpj",'link[rel="import"][name="desktop_polymer"]':"dph",'link[rel="import"][name="desktop_polymer_selective_initialization_home"]':"dpsihh",'link[rel="import"][name="desktop_polymer_selective_initialization_watch"]':"dpsiwh",'link[rel="import"][name="desktop_polymer_sel_auto_home"]':"dpsahh",
...
g.h.Il=function(a){this.qb()||(this.ib=a,this.C=a.clone(),this.F=this.C.attrs.id||this.F,"video-player"==this.F&&(this.F=this.N,this.C.attrs.id=this.N),this.H.id==this.F&&(this.F+="-player",this.C.attrs.id=this.F),this.C.args.enablejsapi="1",this.C.args.playerapiid=this.N,this.ia||(this.ia=vh(this,this.C.args.jsapicallback||"onYouTubePlayerReady")),this.C.args.jsapicallback=null,(a=this.C.attrs.width)&&g.kc(this.H,Number(a)||a),(a=this.C.attrs.height)&&g.jc(this.H,Number(a)||a),oba(this),this.L&&
oh(this))};
g.h.Iw=function(){return this.ib};
g.h.tj=function(){if(!this.qb()){var a=ph(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b){if(this.V=!1,!a.isNotServable||!a.isNotServable(this.C.args.video_id)){mh(this);this.L=!0;a=ph(this);a.addEventListener&&(this.W=th(this,a,"addEventListener"));a.removeEventListener&&(this.aa=th(this,a,"removeEventListener"));b=a.getApiInterface();b=b.concat(a.getInternalApiInterface());for(var c=0;c<b.length;c++){var d=b[c];this.api[d]||(this.api[d]=th(this,a,d))}for(var e in this.D)this.W(e,
this.D[e]);oh(this);this.ia&&this.ia(this.api);this.R.qa("onReady",this.api)}}else this.nb=g.we((0,g.t)(this.tj,this),50)}};
g.h.ZB=function(){return this.L};
g.h.Ih=function(a,b){var c=vh(this,b);if(c){if(!g.Ha(this.sb,a)&&!this.D[a]){var d=pba(this,a);this.W&&this.W(a,d)}this.R.subscribe(a,c);"onReady"==a&&this.L&&g.we(g.u(c,this.api),0)}};
g.h.yK=function(a,b){if(!this.qb()){var c=vh(this,b);c&&g.Od(this.R,a,c)}};
...
g.h.zx=function(){return this.ma||(ph(this)?"html5":null)};
...
g.h.Y=function(){rh(this);if(this.G&&this.C&&this.G.destroy)try{this.G.destroy()}catch(b){g.oe(b)}this.Sa=null;for(var a in this.D)g.m[this.D[a]]=null;this.ib=this.C=this.api=null;delete this.oa;delete this.H;g.rc.prototype.Y.call(this)};g.xh={};g.wh="player_uid_"+(1E9*Math.random()>>>0);var Eh;g.Dh=Gg();Eh=0;g.Ch=null;g.h=g.Gh.prototype;g.h.KK=function(){this.Ti()||this.init()};
g.h.enable=function(){this.C=1;(0,g.y)("string"==typeof this.page?[this.page]:this.page,function(a){a&&(this.subscribe("init-"+a,this.KK,this),this.subscribe("dispose-"+a,this.dispose,this),g.B("PAGE_NAME")==a&&g.Hh(this))},this)};
...
g.h.clear=function(){g.Fe(this.G);this.G=[]};var Ih=g.r("yt.modules.registry_")||{};g.n("yt.modules.registry_",Ih,void 0);g.Lh=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};g.n("yt.msgs_",g.Lh,void 0);g.n("yt.abuse.botguardInitialized",g.r("yt.abuse.botguardInitialized")||Ke,void 0);g.n("yt.abuse.invokeBotguard",g.r("yt.abuse.invokeBotguard")||g.Le,void 0);g.n("yt.abuse.dclkstatus.checkDclkStatus",g.r("yt.abuse.dclkstatus.checkDclkStatus")||Se,void 0);g.n("yt.player.exports.navigate",g.r("yt.player.exports.navigate")||g.Vh,void 0);g.n("yt.util.activity.init",g.r("yt.util.activity.init")||g.Yf,void 0);g.n("yt.util.activity.getTimeSinceActive",g.r("yt.util.activity.getTimeSinceActive")||g.$f,void 0);
g.n("yt.util.activity.setTimestamp",g.r("yt.util.activity.setTimestamp")||Wf,void 0);var Zh=null;g.ek=window.performance&&window.performance.memory;g.Ki={};var gi=0,ci=[],fi=[],$h=0,di={},ei={},ai=new g.Dd(yba,1E3);var Aba=["server_prefetched_vast","vmap"];var ji,oi;g.ni=null;oi="";var qi=null,ti=[];var xi,Qi,Pi,zi,yi,Gba,Jba,Hba,Iba,Li;zi=0;yi=0;Gba=[900,60,"waiting"];Jba=[500,99,"waiting"];Hba=[300,60,"waiting"];Iba=[400,99,"waiting"];Li=[300,101,"done"];var bj=!1;window.yt=window.yt||{};g.n("yt.setConfig",g.me,void 0);g.n("yt.pushConfigArray",ne,void 0);g.n("yt.getConfig",g.B,void 0);g.n("yt.config.set",g.me,void 0);g.n("yt.config.pushArray",ne,void 0);g.n("yt.config.get",g.B,void 0);g.n("yt.hasMsg",g.Nh,void 0);g.n("yt.setMsg",Mh,void 0);g.n("yt.setGoogMsg",Oh,void 0);g.n("yt.msgs.has",g.Nh,void 0);g.n("yt.msgs.set",Mh,void 0);g.n("yt.msgs.setGoog",Oh,void 0);g.n("yt.pubsub.publish",g.E,void 0);g.n("yt.pubsub.subscribe",g.D,void 0);
g.n("ytcsi.tick",g.Og,void 0);g.v(ej,g.Gh);
ej.prototype.enable=function(){window.onload=Eba;window.onunload=Fba;window.onerror=Iaa;var a=window.ytspf||{};a.enabled?(window.addEventListener&&(window.addEventListener("spfclick",vi),window.addEventListener("spfhistory",wi),window.addEventListener("spfrequest",Ci),window.addEventListener("spfpartprocess",Gi),window.addEventListener("spfpartdone",Hi),window.addEventListener("spfprocess",Ii),window.addEventListener("spfdone",Mi),window.addEventListener("spferror",Ni),window.addEventListener("spfreload",
Oi),window.addEventListener("spfjsbeforeunload",fj)),a.config=a.config||{},window.ytdepmap?window.spf.script.ready("spf",function(){a.enabled=window.spf.init(a.config)}):a.enabled=window.spf.init(a.config),this.subscribe("init",Lba),this.subscribe("dispose",Mba)):window.spf.dispose();
this.subscribe("init",this.init,this);this.subscribe("dispose",this.dispose,this)};
ej.prototype.init=function(){ej.M.init.call(this);(window.ytspf||{}).enabled||window.spf.dispose();var a=window.ytPageFrameLoaded||!1;if(!a&&g.B("PAGEFRAME_JS")){var b=g.B("PAGEFRAME_JS",void 0);var c=function(){var a=g.r("ytbin.www.pageframe.setup");a&&(window.ytPageFrameLoaded=!0,a())}}else a&&(a=g.r("yt.www.masthead.loadSearchbox"))&&a();
...
g.n("yt.abuse.botguardInitialized",Ke,void 0);g.n("yt.abuse.invokeBotguard",g.Le,void 0);g.n("yt.abuse.dclkstatus.checkDclkStatus",Se,void 0);g.n("yt.player.exports.navigate",g.Vh,void 0);g.n("yt.util.activity.init",g.Yf,void 0);g.n("yt.util.activity.getTimeSinceActive",g.$f,void 0);g.n("yt.util.activity.setTimestamp",Wf,void 0);pi(g.r("ytplayer.config"));g.r("ytspf.enabled")&&Cba();bh();iba();kh(!0);g.Ng(!1);g.B("SERVICE_WORKER_KILLSWITCH",void 0)||window.navigator.serviceWorker&&window.navigator.serviceWorker.getRegistrations&&
"https:"==window.location.protocol&&(g.se("service_worker_enabled")?bca():$ba())};
ej.prototype.dispose=function(){g.ye(this.D);var a=g.r("ytbin.www.pageframe.cancelSetup");a&&a();g.Ae(ji);if(a=g.li())a.removeEventListener("onReady",ki),a.removeEventListener("onStateChange",ki);kh(!1);(a=(a=(a=window.document.getElementById("ticker"))&&"TRIGGER_CONDITION_ENABLE_NOTIFICATIONS_PROMPT"==g.C(a,"trigger-condition")?a:null)?a.querySelector(".yt-uix-button-alert-info"):null)&&g.xf(a);ej.M.dispose.call(this)};
ej.prototype.disable=function(){ej.M.disable.call(this);window.removeEventListener&&(window.removeEventListener("spfclick",vi),window.removeEventListener("spfhistory",wi),window.removeEventListener("spfrequest",Ci),window.removeEventListener("spfpartprocess",Gi),window.removeEventListener("spfpartdone",Hi),window.removeEventListener("spfprocess",Ii),window.removeEventListener("spfdone",Mi),window.removeEventListener("spferror",Ni),window.removeEventListener("spfreload",Oi),window.removeEventListener("spfjsbeforeunload",
fj));window.onload=null;window.onunload=null;window.onerror=null};
g.Kh(new ej);})(_yt_www);
